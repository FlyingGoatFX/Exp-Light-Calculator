...
A light meter can be used to measure irradiance and determine what exposure parameters would best suit the shot.  
This tool starts with target exposure parameters or irradiance and works backward to determine how powerful the light source should be.
These values can then be saved in a separate .txt file.
...
may be pretty drastically underestimated depending on how much they're spotted, and light sources with egg crates/grid modifiers will be overestimated at closer distances.
